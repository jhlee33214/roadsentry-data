...
```sh
python3 read_roads.py roads-9b6368d0b51f.bin.gz
python3 read_roads.py roads-9b6368d0b51f.bin.gz --geojsonl roads.geojsonl
```
...
```sh
gzip -dc roads-9b6368d0b51f.bin.gz > roads.bin
shasum -a 256 roads.bin roads-9b6368d0b51f.bin.gz
```
